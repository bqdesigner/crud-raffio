...
function submitForm() {
	...
	user.usuario = document.getElementById("novo-usuario").value;
	user.email = document.getElementById("novo-email").value;
	user.senha = document.getElementById("nova-senha").value;
